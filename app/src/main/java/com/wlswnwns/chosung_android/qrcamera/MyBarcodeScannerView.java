...
public abstract class MyBarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    private float mBorderAlpha = 0.0f;
    ...
    public final void setupLayout(CameraWrapper cameraWrapper) {
        ...
        if (!mShouldScaleToFill) {
           ...
           // relativeLayout.setBackground(getResources().getDrawable(R.drawable.camera_qrguide_place));
    ...
    protected IViewFinder createViewFinderView(Context context) {
     ...
     //   viewFinderView.setLaserEnabled(mIsLaserEnabled);
        ...
        // viewFinderView.setViewFinderOffset(100);

        viewFinderView.setBorderAlpha(0.0f);
    ...
    public void startCamera(int cameraId) {
        if (mCameraHandlerThread == null) {
            mCameraHandlerThread = new MyCameraHandlerThread(this);
        }
